  ...
  return (
    ...
    >
      <div id="settings-dialog" className="modal-content max-w-2xl">
        <div className="flex items-center justify-between border-b border-sand-300 px-5 py-4 dark:border-forest-600">
        ...
        <div className="flex flex-wrap gap-2 border-b border-sand-300 px-5 py-3 dark:border-forest-600">
          {SETTINGS_NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-forest-500 ${
                  isActive
